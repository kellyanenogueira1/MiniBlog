<html lang="pt-br">
    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <form class="m-5" action="../controllers/registrar.php">
                    <h4>Cadastre-se agora mesmo!</h4>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="email" id="email" placeholder="Digite seu email" required="requiored">
                    </div>
                    ...
                    <div class="form-group">
                        <input class="btn btn-outline-dark btn-block" type="submit" value="Criar Conta">
                    </div>
